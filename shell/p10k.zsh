# Generated by Powerlevel10k configuration wizard on 2026-02-05 at 18:32 CET.
...
#    chezmoi_shell           # chezmoi shell (https://www.chezmoi.io/)
 #   vi_mode                 # vi mode (you don't need this if you've enabled prompt_char)
  ...
  typeset -g POWERLEVEL9K_LEFT_SUBSEGMENT_SEPARATOR='%252F\uE0B1'
  # Separator between same-color segments on the right.
  typeset -g POWERLEVEL9K_RIGHT_SUBSEGMENT_SEPARATOR='%252F\uE0B3'
